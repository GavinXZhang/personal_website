...
export default function About() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-12 md:pt-20 pb-16 md:pb-32 relative">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <section className="mb-12 md:mb-16">
            <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 text-gray">From Passion to Profession</h2>
          ...
          {/* Removed the white card <motion.div> wrapper */}
          <section className="mb-12 md:mb-16">
            <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 text-gray">Outside of Code</h2>
          ...
          <section className="text-center mt-12 md:mt-16">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 md:gap-4 px-4 md:px-0">
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                className="w-full sm:w-auto px-6 py-3 bg-gray-100 text-gray-800 font-semibold rounded-lg shadow-md hover:bg-gray-200 transition-colors duration-300 text-center"
              >
                Download Resume
              </motion.a>
              <motion.a
                href="https://www.linkedin.com/in/gavin-x-zhang/"
                target="_blank"
